...
Status: **live in production**, deployado en `xindeler.com/api/*`, actualmente en `v2.1.0`
(2026-09-06). El primer tag arranca en `v2.0.0`, no `v1.0.0`: hubo ~4 deploys manuales previos
sin tag, y ese release en particular fue además un cambio estructural (cierre de `xindeler-auth`
al exterior).
...
| `GET` | `/api/account/characters/{character_id}/portrait` | ✅ Fase F (NH-79) |
| `GET` | `/api/download` | ✅ Download resolver |
| `GET` | `/api/download-launcher` | ✅ Launcher download resolver (NH-145) |
